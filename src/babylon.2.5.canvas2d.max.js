  ...
  var ObservableArray = (function (_super) {
    ...
    ObservableArray.prototype.setAt = function (index, value) {
      ...
      if (ac) {
        ...
        if (insertion) {
          ac.newItems.splice(0, ac.newItems.length, {
            index: index,
            value: value
          });
          ...
          ac.changedItems.splice(0, ac.changedItems.length, {
            index: index,
            value: value
          });
        }
    ...
    ObservableArray.prototype.shift = function () {
      ...
      if (oldLength !== 0) {
        ...
        if (ac) {
          ac.action = ArrayChanged.replacedArrayAction;
          ac.removedItems.splice(0, ac.removedItems.length, {
            index: 0,
            value: res
          });
          ac.newItems.splice(0);
  ...
  var ObservableStringDictionary = (function (_super) {
    ...
    ObservableStringDictionary.prototype.copyFrom = function (source) {
      ...
      source.forEach(function (t, v) {
        return _this._add(t, v, false, _this._watchObjectsPropertyChange);
      });
    ...
    ObservableStringDictionary.prototype._add = function (key, value, fireNotif, registerWatcher) {
      if (_super.prototype.add.call(this, key, value)) {
        if (fireNotif) {
          this.onDictionaryChanged(DictionaryChanged.newItemAction, {
            key: key,
            value: value
          }, null, null);
    ...
    ObservableStringDictionary.prototype.set = function (key, value) {
      ...
      if (_super.prototype.set.call(this, key, value)) {
        this.onDictionaryChanged(DictionaryChanged.itemValueChangedAction, null, null, {
          key: key,
          oldValue: oldValue,
          newValue: value
        });
  ...
  var GradientColorBrush2D = (function (_super) {
    ...
    function GradientColorBrush2D(color1, color2, translation, rotation, scale, lock) {
      if (translation === void 0) {
        translation = BABYLON.Vector2.Zero();
      }
      if (rotation === void 0) {
        rotation = 0;
      }
...
(function (BABYLON) {
    ...
    Object.defineProperty(ClassTreeInfo.prototype, "fullContent", {
      get: function () {
        if (!this._fullContent) {
          ...
          var curLevel = this;
          while (curLevel) {
            curLevel.levelContent.forEach(function (k, v) {
              return dic_1.add(k, v);
            });
  ...
  var SmartPropertyBase = (function (_super) {
    ...
    SmartPropertyBase._createPropInfo = function (target, propName, propId, kind, settings) {
      var dic = ClassTreeInfo.getOrRegister(target, function () {
        return new Prim2DClassInfo();
      });
  ...
  var MonitoredObjectData = (function () {
    function MonitoredObjectData(monitoredObject) {
      ...
      this.observer = this.monitoredObject.propertyChanged.add(function (e, s) {
        _this.propertyChangedHandler(e.propertyName, e.oldValue, e.newValue);
      });
  ...
  var BindingHelper = (function () {
    ...
    BindingHelper.registerDataSource = function (dataSource, binding) {
      ...
      var _loop_1 = function (i) {
        ...
        var bi = BABYLON.Tools.first(bindingInfos, function (cbi) {
          return cbi.binding === binding;
        });
        if (!bi) {
    ...
    BindingHelper._getMonitoredObjectData = function (object) {
      ...
      var mod = BindingHelper._monitoredObjects.getOrAddWithFactory(objectId, function (k) {
        return new MonitoredObjectData(object);
      });
      return mod;
    };
    ...
    BindingHelper._getObjectTypePropertyIDs = function (obj) {
      ...
      var d = BindingHelper._propertiesID.getOrAddWithFactory(fullName, function () {
        return new BABYLON.StringDictionary();
      });
      return d;
    };
    BindingHelper._getPropertyID = function (object, propName) {
      ...
      var propData = otd.getOrAddWithFactory(propName, function (k) {
        return 1 << otd.count;
      });
      return propData;
    };
  ...
  function dependencyProperty(propId, piStore, mode, updateSourceTrigger) {
    if (mode === void 0) {
      mode = DataBinding.MODE_TWOWAY;
    }
    if (updateSourceTrigger === void 0) {
      updateSourceTrigger = DataBinding.UPDATESOURCETRIGGER_PROPERTYCHANGED;
    }
    return SmartPropertyBase._hookProperty(propId, piStore, Prim2DPropInfo.PROPKIND_DYNAMIC, {
      bindingMode: mode,
  ...
  function modelLevelProperty(propId, piStore, typeLevelCompare, dirtyBoundingInfo, dirtyParentBoundingBox) {
    if (typeLevelCompare === void 0) {
      typeLevelCompare = false;
    }
    if (dirtyBoundingInfo === void 0) {
      dirtyBoundingInfo = false;
    }
    if (dirtyParentBoundingBox === void 0) {
      dirtyParentBoundingBox = false;
    }
    return SmartPropertyBase._hookProperty(propId, piStore, Prim2DPropInfo.PROPKIND_MODEL, {
      typeLevelCompare: typeLevelCompare,
      dirtyBoundingInfo: dirtyBoundingInfo,
      dirtyParentBoundingBox: dirtyParentBoundingBox
    });
  }
  ...
  function instanceLevelProperty(propId, piStore, typeLevelCompare, dirtyBoundingInfo, dirtyParentBoundingBox) {
    ...
    return SmartPropertyBase._hookProperty(propId, piStore, Prim2DPropInfo.PROPKIND_INSTANCE, {
      typeLevelCompare: typeLevelCompare,
      dirtyBoundingInfo: dirtyBoundingInfo,
      dirtyParentBoundingBox: dirtyParentBoundingBox
    });
...
(function (BABYLON) {
  ...
  var PrimitivePointerInfo = (function () {
    ...
    PrimitivePointerInfo.getEventTypeName = function (mask) {
      switch (mask) {
      case PrimitivePointerInfo.PointerOver:
        return "PointerOver";
      case PrimitivePointerInfo.PointerEnter:
        return "PointerEnter";
      case PrimitivePointerInfo.PointerDown:
        return "PointerDown";
      case PrimitivePointerInfo.PointerMouseWheel:
        return "PointerMouseWheel";
      case PrimitivePointerInfo.PointerMove:
        return "PointerMove";
      case PrimitivePointerInfo.PointerUp:
        return "PointerUp";
      case PrimitivePointerInfo.PointerOut:
        return "PointerOut";
      case PrimitivePointerInfo.PointerLeave:
        return "PointerLeave";
      case PrimitivePointerInfo.PointerGotCapture:
        return "PointerGotCapture";
      case PrimitivePointerInfo.PointerLostCapture:
  ...
  var PrimitiveAlignment = (function () {
    ...
    Object.defineProperty(PrimitiveAlignment, "AlignLeft", {
       ...
       */
      get: function () {
        return PrimitiveAlignment._AlignLeft;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(PrimitiveAlignment, "AlignTop", {
       ...
       */
      get: function () {
        return PrimitiveAlignment._AlignTop;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(PrimitiveAlignment, "AlignRight", {
       ...
       */
      get: function () {
        return PrimitiveAlignment._AlignRight;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(PrimitiveAlignment, "AlignBottom", {
       ...
       */
      get: function () {
        return PrimitiveAlignment._AlignBottom;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(PrimitiveAlignment, "AlignCenter", {
       ...
       */
      get: function () {
        return PrimitiveAlignment._AlignCenter;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(PrimitiveAlignment, "AlignStretch", {
       ...
       */
      get: function () {
        return PrimitiveAlignment._AlignStretch;
      },
      enumerable: true,
      configurable: true
    });
  ...
  var PrimitiveThickness = (function () {
    ...
    PrimitiveThickness.prototype.computeWithAlignment = function (sourceArea, contentSize, alignment, dstOffset, dstArea, computeLayoutArea) {
      if (computeLayoutArea === void 0) {
        computeLayoutArea = false;
      }
      // Fetch some data
  ...
  var Prim2DBase = (function (_super) {
      ...
      get: function () {
        ...
        if (!this._margin) {
          this._margin = new PrimitiveThickness(function () {
            ...
            return _this._positioningDirty();
          });
        }
        return this._margin;
      },
      ...
      set: function (value) {
        ...
        if (value === false) {
          ...
          this._debugAreaGroup = new BABYLON.Group2D({
            ...
            parent: (this.parent != null) ? this.parent : this,
            id: "###DEBUG AREA GROUP###",
            children: [
              new BABYLON.Group2D({
                id: "###Layout Area###",
      ...
      if (this._parent) {
        if (this instanceof BABYLON.Group2D) {
          ...
          if (g.isRenderableGroup) {
            var parentRenderable = this.parent.traverseUp(function (p) {
              return (p instanceof BABYLON.Group2D && p.isRenderableGroup);
            });
    ...
    Prim2DBase.prototype._patchHierarchy = function (owner) {
      ...
      this._renderGroup = this.traverseUp(function (p) {
        return p instanceof BABYLON.Group2D && p.isRenderableGroup;
      });
      if (this._parent) {
        this._parentLayoutDirty();
    ...
    Prim2DBase._totalCount = 0;
    __decorate([
      BABYLON.instanceLevelProperty(1, function (pi) {
        return Prim2DBase.actualPositionProperty = pi;
      }, false, false, true)
    ], Prim2DBase.prototype, "actualPosition", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 1, function (pi) {
        return Prim2DBase.actualXProperty = pi;
      }, false, false, true)
    ], Prim2DBase.prototype, "actualX", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 2, function (pi) {
        return Prim2DBase.actualYProperty = pi;
      }, false, false, true)
    ], Prim2DBase.prototype, "actualY", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 3, function (pi) {
        return Prim2DBase.positionProperty = pi;
      }, false, false, true)
    ], Prim2DBase.prototype, "position", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 4, function (pi) {
        return Prim2DBase.xProperty = pi;
      }, false, false, true)
    ], Prim2DBase.prototype, "x", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 5, function (pi) {
        return Prim2DBase.yProperty = pi;
      }, false, false, true)
    ], Prim2DBase.prototype, "y", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 6, function (pi) {
        return Prim2DBase.sizeProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "size", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 7, function (pi) {
        return Prim2DBase.widthProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "width", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 8, function (pi) {
        return Prim2DBase.heightProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "height", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 9, function (pi) {
        return Prim2DBase.rotationProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "rotation", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 10, function (pi) {
        return Prim2DBase.scaleProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "scale", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 11, function (pi) {
        return Prim2DBase.actualSizeProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "actualSize", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 12, function (pi) {
        return Prim2DBase.actualWidthProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "actualWidth", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 13, function (pi) {
        return Prim2DBase.actualHeightProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "actualHeight", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 14, function (pi) {
        return Prim2DBase.originProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "origin", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 15, function (pi) {
        return Prim2DBase.levelVisibleProperty = pi;
      })
    ], Prim2DBase.prototype, "levelVisible", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 16, function (pi) {
        return Prim2DBase.isVisibleProperty = pi;
      })
    ], Prim2DBase.prototype, "isVisible", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 17, function (pi) {
        return Prim2DBase.zOrderProperty = pi;
      })
    ], Prim2DBase.prototype, "zOrder", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 18, function (pi) {
        return Prim2DBase.marginProperty = pi;
      })
    ], Prim2DBase.prototype, "margin", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 19, function (pi) {
        return Prim2DBase.paddingProperty = pi;
      })
    ], Prim2DBase.prototype, "padding", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 20, function (pi) {
        return Prim2DBase.marginAlignmentProperty = pi;
      })
    ], Prim2DBase.prototype, "marginAlignment", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 21, function (pi) {
        return Prim2DBase.opacityProperty = pi;
      })
    ], Prim2DBase.prototype, "opacity", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 22, function (pi) {
        return Prim2DBase.scaleXProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "scaleX", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 23, function (pi) {
        return Prim2DBase.scaleYProperty = pi;
      }, false, true)
    ], Prim2DBase.prototype, "scaleY", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 24, function (pi) {
        return Prim2DBase.actualScaleProperty = pi;
      }, false, true)
...
(function (BABYLON) {
  var GroupInstanceInfo = (function () {
    ...
    GroupInstanceInfo.prototype.dispose = function () {
      ...
      if (this._opaqueData) {
        this._opaqueData.forEach(function (d) {
          return d.dispose(engine);
        });
        this._opaqueData = null;
      }
      if (this._alphaTestData) {
        this._alphaTestData.forEach(function (d) {
          return d.dispose(engine);
        });
        this._alphaTestData = null;
      }
      if (this._transparentData) {
        this._transparentData.forEach(function (d) {
          return d.dispose(engine);
        });
        this._transparentData = null;
      }
  ...
  var TransparentSegment = (function () {
    ...
    TransparentSegment.prototype.dispose = function (engine) {
      if (this.partBuffers) {
        this.partBuffers.forEach(function (b) {
          return engine._releaseBuffer(b);
        });
...
(function (BABYLON) {
  ...
  function instanceData(category, shaderAttributeName) {
    return function (target, propName, descriptor) {
      var dic = BABYLON.ClassTreeInfo.getOrRegister(target, function (base) {
        return new InstanceClassInfo(base);
      });
      var node = dic.getLevelOf(target);
  ...
  var RenderablePrim2D = (function (_super) {
    ...
    RenderablePrim2D.prototype.getDataPartEffectInfo = function (dataPartId, vertexBufferAttributes, uniforms, useInstanced) {
      ...
      if (useInstanced === void 0) {
        useInstanced = null;
      }
      var dataPart = BABYLON.Tools.first(this._instanceDataParts, function (i) {
        return i.id === dataPartId;
      });
      if (!dataPart) {
        return null;
      }
    ...
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 0, function (pi) {
        return RenderablePrim2D.isAlphaTestProperty = pi;
      })
    ], RenderablePrim2D.prototype, "isAlphaTest", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 1, function (pi) {
        return RenderablePrim2D.isTransparentProperty = pi;
      })
...
(function (BABYLON) {
  var Shape2D = (function (_super) {
    ...
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1, function (pi) {
        return Shape2D.borderProperty = pi;
      }, true)
    ], Shape2D.prototype, "border", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 2, function (pi) {
        return Shape2D.fillProperty = pi;
      }, true)
    ], Shape2D.prototype, "fill", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 3, function (pi) {
        return Shape2D.borderThicknessProperty = pi;
      })
  ...
  var Group2D = (function (_super) {
    ...
    Group2D.prototype._prepareGroupRender = function (context) {
      ...
      if ((rd._primDirtyList.length > 0) || context.forceRefreshPrimitive) {
        sortedDirtyList = rd._primDirtyList.sort(function (a, b) {
    ...
    Group2D.prototype._updateTransparentData = function () {
      ...
      rd._transparentPrimitives.sort(function (a, b) {
        return b._primitive.actualZOffset - a._primitive.actualZOffset;
      });
      ...
      case BABYLON.Render2DContext.RenderModeOpaque:
        {
          ...
          setDirty = function (dirty) {
            gii.opaqueDirty = dirty;
          };
          getDirty = function () {
            return gii.opaqueDirty;
          };
    ...
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 1, function (pi) {
        return Group2D.sizeProperty = pi;
      }, false, true)
    ], Group2D.prototype, "size", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 2, function (pi) {
        return Group2D.actualSizeProperty = pi;
      })
...
(function (BABYLON) {
  ...
  var Rectangle2D = (function (_super) {
    ...
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 1, function (pi) {
        return Rectangle2D.actualSizeProperty = pi;
      }, false, true)
    ], Rectangle2D.prototype, "actualSize", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 2, function (pi) {
        return Rectangle2D.notRoundedProperty = pi;
      })
    ], Rectangle2D.prototype, "notRounded", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 3, function (pi) {
        return Rectangle2D.roundRadiusProperty = pi;
      })
  ...
  var Ellipse2D = (function (_super) {
    ...
    Ellipse2D.prototype.setupModelRenderCache = function (modelRenderCache) {
      ...
      if (this.fill) {
        ...
        var ei = this.getDataPartEffectInfo(BABYLON.Shape2D.SHAPE2D_FILLPARTID, ["index"], null, true);
        if (ei) {
          renderCache.effectFillInstanced = engine.createEffect({
            vertex: "ellipse2d",
            fragment: "ellipse2d"
          }, ei.attributes, ei.uniforms, [], ei.defines, null);
        }
        // Get the non instanced version
        ei = this.getDataPartEffectInfo(BABYLON.Shape2D.SHAPE2D_FILLPARTID, ["index"], null, false);
        renderCache.effectFill = engine.createEffect({
          vertex: "ellipse2d",
          fragment: "ellipse2d"
        }, ei.attributes, ei.uniforms, [], ei.defines, null);
      }
    ...
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 1, function (pi) {
        return Ellipse2D.acutalSizeProperty = pi;
      }, false, true)
    ], Ellipse2D.prototype, "actualSize", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 2, function (pi) {
        return Ellipse2D.subdivisionsProperty = pi;
      })
...
(function (BABYLON) {
  ...
  var Sprite2D = (function (_super) {
    ...
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1, function (pi) {
        return Sprite2D.textureProperty = pi;
      })
    ], Sprite2D.prototype, "texture", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 2, function (pi) {
        return Sprite2D.useAlphaFromTextureProperty = pi;
      })
    ], Sprite2D.prototype, "useAlphaFromTexture", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 3, function (pi) {
        return Sprite2D.actualSizeProperty = pi;
      }, false, true)
    ], Sprite2D.prototype, "actualSize", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 4, function (pi) {
        return Sprite2D.spriteLocationProperty = pi;
      })
    ], Sprite2D.prototype, "spriteLocation", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 5, function (pi) {
        return Sprite2D.spriteFrameProperty = pi;
      })
    ], Sprite2D.prototype, "spriteFrame", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 6, function (pi) {
        return Sprite2D.invertYProperty = pi;
      })
    ], Sprite2D.prototype, "invertY", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 7, function (pi) {
        return Sprite2D.spriteScaleFactorProperty = pi;
      })
...
(function (BABYLON) {
  ...
  var Text2D = (function (_super) {
    ...
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1, function (pi) {
        return Text2D.fontProperty = pi;
      }, false, true)
    ], Text2D.prototype, "fontName", null);
    __decorate([
      BABYLON.dynamicLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 2, function (pi) {
        return Text2D.defaultFontColorProperty = pi;
      })
    ], Text2D.prototype, "defaultFontColor", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 3, function (pi) {
        return Text2D.textProperty = pi;
      }, false, true)
    ], Text2D.prototype, "text", null);
    __decorate([
      BABYLON.instanceLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 4, function (pi) {
        return Text2D.sizeProperty = pi;
      })
    ], Text2D.prototype, "size", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 5, function (pi) {
        return Text2D.fontSuperSampleProperty = pi;
      }, false, false)
    ], Text2D.prototype, "fontSuperSample", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 6, function (pi) {
        return Text2D.fontSuperSampleProperty = pi;
      }, false, false)
...
(function (BABYLON) {
  ...
  var Lines2D = (function (_super) {
    ...
    Object.defineProperty(Lines2D, "SquareAnchorCap", {
       ...
       */
      get: function () {
        return Lines2D._squareAnchorCap;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(Lines2D, "RoundAnchorCap", {
       ...
       */
      get: function () {
        return Lines2D._roundAnchorCap;
      },
      enumerable: true,
      configurable: true
    });
    Object.defineProperty(Lines2D, "DiamondAnchorCap", {
       ...
       */
      get: function () {
        return Lines2D._diamondAnchorCap;
      },
      enumerable: true,
      configurable: true
    });
    ...
    Lines2D.prototype.setupModelRenderCache = function (modelRenderCache) {
      ...
      if (this.border) {
        ...
        if (ei) {
          renderCache.effectBorderInstanced = engine.createEffect({
            vertex: "lines2d",
            fragment: "lines2d"
          }, ei.attributes, ei.uniforms, [], ei.defines, null);
        }
        ...
        renderCache.effectBorder = engine.createEffect({
          vertex: "lines2d",
          fragment: "lines2d"
        }, ei.attributes, ei.uniforms, [], ei.defines, null);
      }
    ...
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 1, function (pi) {
        return Lines2D.pointsProperty = pi;
      })
    ], Lines2D.prototype, "points", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 2, function (pi) {
        return Lines2D.fillThicknessProperty = pi;
      })
    ], Lines2D.prototype, "fillThickness", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 3, function (pi) {
        return Lines2D.closedProperty = pi;
      })
    ], Lines2D.prototype, "closed", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 4, function (pi) {
        return Lines2D.startCapProperty = pi;
      })
    ], Lines2D.prototype, "startCap", null);
    __decorate([
      BABYLON.modelLevelProperty(BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 5, function (pi) {
        return Lines2D.endCapProperty = pi;
      })
  ...
  var Canvas2D = (function (_super) {
    ...
    function Canvas2D(scene, settings) {
      ...
      if (this._cachingStrategy !== Canvas2D.CACHESTRATEGY_TOPLEVELGROUPS) {
        this._background = new BABYLON.Rectangle2D({
          parent: this,
          id: "###CANVAS BACKGROUND###",
          size: settings.size
        }); //TODO CHECK when size is null
      ...
      this.__engineData = engine.getOrAddExternalDataWithFactory("__BJSCANVAS2D__", function (k) {
        return new Canvas2DEngineBoundData();
      });
    ...
    Canvas2D.prototype.dispose = function () {
      ...
      if (this._groupCacheMaps) {
        this._groupCacheMaps.forEach(function (k, m) {
    ...
    Canvas2D.prototype.createCanvasProfileInfoCanvas = function () {
      ...
      var canvas = new ScreenSpaceCanvas2D(this.scene, {
        id: "ProfileInfoCanvas",
        cachingStrategy: Canvas2D.CACHESTRATEGY_DONTCACHE,
        children: [
        new BABYLON.Rectangle2D({
            id: "ProfileButton",
            border: "#ECECECEE",
          ...
          new BABYLON.Rectangle2D({
            ...
            padding: "10",
            children: [
              new BABYLON.Text2D("Stats", {
                id: "ProfileInfoText",
                marginAlignment: "h: left, v: top",
                fontName: "12pt Lucida Console",
      ...
      this._profilingMinimized = false;

      var button = canvas.findById("ProfileButton");
      button.pointerEventObservable.add(function (d, s) {
        this._profilingMinimized = !this._profilingMinimized; 
    ...
    Canvas2D.prototype._updateProfileCanvas = function () {
      ...
      if (this._profilingMinimized) {
              this._profileInfoText.text = "";
              return;
            }
    ...
    Canvas2D.prototype._allocateGroupCache = function (group, parent, minSize, useMipMap, anisotropicLevel) {
      ...
      var mapArray = this._groupCacheMaps.getOrAddWithFactory(key, function () {
        return new Array();
      });
      ...
      if (group !== this || this._isScreenSpace) {
        ...
        if (this._cachingStrategy === Canvas2D.CACHESTRATEGY_CANVAS) {
          ...
          sprite = new BABYLON.Sprite2D(map, {
            parent: this._cachedCanvasGroup,
            id: "__cachedCanvasSprite__",
            spriteSize: originalSize,
            spriteLocation: node.pos
          });
          sprite.zOrder = 1;
          ...
          sprite = new BABYLON.Sprite2D(map, {
            parent: parent,
            id: "__cachedSpriteOfGroup__" + group.id,
            x: group.actualPosition.x,
            y: group.actualPosition.y,
            spriteSize: originalSize,
            spriteLocation: node.pos,
            dontInheritParentScale: true
          });
    ...
    Canvas2D.GetSolidColorBrush = function (color) {
      return Canvas2D._solidColorBrushes.getOrAddWithFactory(color.toHexString(), function () {
        return new BABYLON.SolidColorBrush2D(color.clone(), true);
      });
    };
    /**
    ...
    Canvas2D.GetSolidColorBrushFromHex = function (hexValue) {
      return Canvas2D._solidColorBrushes.getOrAddWithFactory(hexValue, function () {
        return new BABYLON.SolidColorBrush2D(BABYLON.Color4.FromHexString(hexValue), true);
      });
    };
    /**
    ...
    Canvas2D.GetGradientColorBrush = function (color1, color2, translation, rotation, scale) {
      ...
      return Canvas2D._gradientColorBrushes.getOrAddWithFactory(BABYLON.GradientColorBrush2D.BuildKey(color1, color2, translation, rotation, scale), function () {
        return new BABYLON.GradientColorBrush2D(color1, color2, translation, rotation, scale, true);
      });
    };
    /**
...
(function (BABYLON) {
  ...
  var UIElement = (function (_super) {
    ...
    UIElement.prototype._createVisualTree = function () {
      ...
      this._visualPlaceholder = new BABYLON.Group2D({
        parent: parentPrim,
        id: "GUI " + BABYLON.Tools.getClassName(this) + " RootGroup of " + this.id
      });
    ...
    Object.defineProperty(UIElement.prototype, "_position", {
      get: function () {
          return null;
        } // TODO use abstract keyword when TS 2.0 will be approved
        ,
      enumerable: true,
      configurable: true
    });
    ...
    __decorate([
      BABYLON.dependencyProperty(0, function (pi) {
        return UIElement.parentProperty = pi;
      })
    ], UIElement.prototype, "parent", null);
    __decorate([
      BABYLON.dependencyProperty(1, function (pi) {
        return UIElement.widthProperty = pi;
      })
    ], UIElement.prototype, "width", null);
    __decorate([
      BABYLON.dependencyProperty(2, function (pi) {
        return UIElement.heightProperty = pi;
      })
    ], UIElement.prototype, "height", null);
    __decorate([
      BABYLON.dependencyProperty(3, function (pi) {
        return UIElement.minWidthProperty = pi;
      })
    ], UIElement.prototype, "minWidth", null);
    __decorate([
      BABYLON.dependencyProperty(4, function (pi) {
        return UIElement.minHeightProperty = pi;
      })
    ], UIElement.prototype, "minHheight", null);
    __decorate([
      BABYLON.dependencyProperty(5, function (pi) {
        return UIElement.maxWidthProperty = pi;
      })
    ], UIElement.prototype, "maxWidth", null);
    __decorate([
      BABYLON.dependencyProperty(6, function (pi) {
        return UIElement.maxHeightProperty = pi;
      })
    ], UIElement.prototype, "maxHeight", null);
    __decorate([
      BABYLON.dependencyProperty(7, function (pi) {
        return UIElement.actualWidthProperty = pi;
      })
    ], UIElement.prototype, "actualWidth", null);
    __decorate([
      BABYLON.dependencyProperty(8, function (pi) {
        return UIElement.actualHeightProperty = pi;
      })
    ], UIElement.prototype, "actualHeight", null);
    __decorate([
      BABYLON.dynamicLevelProperty(9, function (pi) {
        return UIElement.marginProperty = pi;
      })
    ], UIElement.prototype, "margin", null);
    __decorate([
      BABYLON.dynamicLevelProperty(10, function (pi) {
        return UIElement.paddingProperty = pi;
      })
    ], UIElement.prototype, "padding", null);
    __decorate([
      BABYLON.dynamicLevelProperty(11, function (pi) {
        return UIElement.marginAlignmentProperty = pi;
      })
    ], UIElement.prototype, "marginAlignment", null);
    __decorate([
      BABYLON.dynamicLevelProperty(12, function (pi) {
        return UIElement.paddingAlignmentProperty = pi;
      })
    ], UIElement.prototype, "paddingAlignment", null);
    __decorate([
      BABYLON.dynamicLevelProperty(13, function (pi) {
        return UIElement.isEnabledProperty = pi;
      })
    ], UIElement.prototype, "isEnabled", null);
    __decorate([
      BABYLON.dynamicLevelProperty(14, function (pi) {
        return UIElement.isFocusedProperty = pi;
      })
    ], UIElement.prototype, "isFocused", null);
    __decorate([
      BABYLON.dynamicLevelProperty(15, function (pi) {
        return UIElement.isMouseOverProperty = pi;
      })
  ...
  var GUIManager = (function () {
    ...
    GUIManager.registerStyle = function (uiElType, templateName, style) {
      var templates = GUIManager.stylesByUIElement.getOrAddWithFactory(uiElType, function () {
        return new BABYLON.StringDictionary();
      });
    ...
    GUIManager.registerRenderingTemplate = function (uiElType, templateName, factory) {
      var templates = GUIManager.renderingTemplatesByUIElement.getOrAddWithFactory(uiElType, function () {
        return new BABYLON.StringDictionary();
      });
      if (templates.contains(templateName)) {
...
(function (BABYLON) {
  var StackPanel = (function (_super) {
    ...
    StackPanel.prototype.createVisualTree = function () {
      ...
      this._childrenPlaceholder = new BABYLON.Group2D({
        parent: this._visualPlaceholder,
        id: "StackPanel Children Placeholder of " + this.id
      });
    ...
    __decorate([
      BABYLON.dependencyProperty(StackPanel.STACKPANEL_PROPCOUNT + 0, function (pi) {
        return StackPanel.orientationHorizontalProperty = pi;
      })
  ...
  var DefaultStackPanelRenderingTemplate = (function (_super) {
    ...
    DefaultStackPanelRenderingTemplate.prototype.createVisualTree = function (owner, visualPlaceholder) {
      return {
        root: visualPlaceholder,
        contentPlaceholder: visualPlaceholder
      };
    };
    ...
    DefaultStackPanelRenderingTemplate = __decorate([
      BABYLON.registerWindowRenderingTemplate("BABYLON.StackPanel", "Default", function () {
        return new DefaultStackPanelRenderingTemplate();
      })
...
(function (BABYLON) {
  var Control = (function (_super) {
    ...
    __decorate([
      BABYLON.dependencyProperty(BABYLON.UIElement.UIELEMENT_PROPCOUNT + 0, function (pi) {
        return Control.backgroundProperty = pi;
      })
    ], Control.prototype, "background", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.UIElement.UIELEMENT_PROPCOUNT + 1, function (pi) {
        return Control.borderProperty = pi;
      })
    ], Control.prototype, "border", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.UIElement.UIELEMENT_PROPCOUNT + 2, function (pi) {
        return Control.borderThicknessProperty = pi;
      })
    ], Control.prototype, "borderThickness", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.UIElement.UIELEMENT_PROPCOUNT + 3, function (pi) {
        return Control.fontNameProperty = pi;
      })
    ], Control.prototype, "fontName", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.UIElement.UIELEMENT_PROPCOUNT + 4, function (pi) {
        return Control.foregroundProperty = pi;
      })
...
(function (BABYLON) {
  var ContentControl = (function (_super) {
    ...
    ContentControl.prototype._createVisualTree = function () {
      ...
      this._contentPlaceholder = new BABYLON.Group2D({
        parent: this._visualPlaceholder,
        id: "ContentControl Content Placeholder of " + this.id
      });
    ...
    ContentControl.prototype._buildContentUIElement = function () {
      ...
      if (c instanceof BABYLON.UIElement) {
        ...
        var l = new BABYLON.Label({
          parent: this,
          id: "Content of " + this.id
        });
        var binding = new BABYLON.DataBinding();
        binding.propertyPathName = "content";
        binding.stringFormat = function (v) {
          return ("" + v);
        };
    ...
    __decorate([
      BABYLON.dependencyProperty(BABYLON.Control.CONTROL_PROPCOUNT + 0, function (pi) {
        return ContentControl.contentProperty = pi;
      })
...
(function (BABYLON) {
  ...
  var FocusManager = (function () {
    ...
    FocusManager.prototype.setFocusOn = function (el, focusScope) {
      var fsd = (focusScope != null) ? this._focusScopes.getOrAddWithFactory(focusScope.uid, function (k) {
        return new FocusScopeData(focusScope);
      }) : this._rootScope;
  ...
  var GUISceneData = (function () {
    function GUISceneData(scene) {
      this.scene = scene;
      this.screenSpaceCanvas = new BABYLON.ScreenSpaceCanvas2D(scene, {
        id: "GUI Canvas",
  ...
  var Window = (function (_super) {
    ...
    function Window(scene, settings) {
      ...
      if (!settings.worldPosition && !settings.worldRotation) {
        ...
        this._canvas = new BABYLON.WorldSpaceCanvas2D(scene, new BABYLON.Size(w, h), {
          id: "GUI Canvas",
          cachingStrategy: BABYLON.Canvas2D.CACHESTRATEGY_DONTCACHE,
          worldPosition: wpos,
          worldRotation: wrot
      ...
      this._renderObserver = this._canvas.renderObservable.add(function (e, s) {
        return _this._canvasPreRender();
      }, BABYLON.Canvas2D.RENDEROBSERVABLE_PRE);
      this._disposeObserver = this._canvas.disposeObservable.add(function (e, s) {
        return _this._canvasDisposed();
      });
    ...
    Window.prototype._overPrimChanged = function (oldPrim, newPrim) {
      ...
      var newOverEl = null;
      var curGroup = newPrim ? newPrim.traverseUp(function (p) {
        return p instanceof BABYLON.Group2D;
      }) : null;
      while (curGroup) {
        ...
        curGroup = curGroup.parent ? curGroup.parent.traverseUp(function (p) {
          return p instanceof BABYLON.Group2D;
        }) : null;
      }
    ...
    Window.prototype._canvasPreRender = function () {
      ...
      if (this._UIElementVisualToBuildList.length > 0) {
        ...
        var sortedElementList = this._UIElementVisualToBuildList.sort(function (a, b) {
          return a.hierarchyDepth - b.hierarchyDepth;
        });
    ...
    Window.getSceneData = function (scene) {
      return Window._sceneData.getOrAddWithFactory(scene.uid, function (k) {
        return new GUISceneData(scene);
      });
    };
    Window.WINDOW_PROPCOUNT = BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 4;
    Window._sceneData = new BABYLON.StringDictionary();
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 0, function (pi) {
        return Window.leftProperty = pi;
      })
    ], Window.prototype, "left", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 1, function (pi) {
        return Window.bottomProperty = pi;
      })
    ], Window.prototype, "bottom", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 2, function (pi) {
        return Window.positionProperty = pi;
      })
    ], Window.prototype, "position", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 3, function (pi) {
        return Window.isActiveProperty = pi;
      })
  ...
  var DefaultWindowRenderingTemplate = (function (_super) {
    ...
    DefaultWindowRenderingTemplate.prototype.createVisualTree = function (owner, visualPlaceholder) {
      var r = new BABYLON.Rectangle2D({
        parent: visualPlaceholder,
        fill: "#808080FF"
      });
      return {
        root: r,
    ...
    DefaultWindowRenderingTemplate = __decorate([
      BABYLON.registerWindowRenderingTemplate("BABYLON.Window", "Default", function () {
        return new DefaultWindowRenderingTemplate();
      })
...
(function (BABYLON) {
  ...
  var DefaultLabelRenderingTemplate = (function (_super) {
    ...
    DefaultLabelRenderingTemplate = __decorate([
      BABYLON.registerWindowRenderingTemplate("BABYLON.Label", "Default", function () {
        return new DefaultLabelRenderingTemplate();
      })
...
(function (BABYLON) {
  var Button = (function (_super) {
    ...
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTROL_PROPCOUNT + 0, function (pi) {
        return Button.isPushedProperty = pi;
      })
    ], Button.prototype, "isPushed", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTROL_PROPCOUNT + 1, function (pi) {
        return Button.isDefaultProperty = pi;
      })
    ], Button.prototype, "isDefault", null);
    __decorate([
      BABYLON.dependencyProperty(BABYLON.ContentControl.CONTROL_PROPCOUNT + 2, function (pi) {
        return Button.isOutlineProperty = pi;
      })
  ...
  var DefaultButtonRenderingTemplate = (function (_super) {
    ...
    DefaultButtonRenderingTemplate.prototype.createVisualTree = function (owner, visualPlaceholder) {
      this._rect = new BABYLON.Rectangle2D({
        parent: visualPlaceholder,
        fill: "#FF8080FF",
        border: "#FF8080FF",
        roundRadius: 10,
      ...
      return {
        root: this._rect,
        contentPlaceholder: this._rect
      };
    };
    DefaultButtonRenderingTemplate.prototype.attach = function (owner) {
      var _this = this;
      _super.prototype.attach.call(this, owner);
      this.owner.propertyChanged.add(function (e, s) {
          return _this.stateChange();
        }, BABYLON.UIElement.isEnabledProperty.flagId |
      ...
      var button = owner;
      button.normalStateBackground.dictionaryChanged.add(function (e, c) {
        return _this.stateChange();
      });
      button.normalStateBorder.dictionaryChanged.add(function (e, c) {
        return _this.stateChange();
      });
      button.defaultStateBackground.dictionaryChanged.add(function (e, c) {
        return _this.stateChange();
      });
      button.defaultStateBorder.dictionaryChanged.add(function (e, c) {
        return _this.stateChange();
      });
    };
    ...
    DefaultButtonRenderingTemplate = __decorate([
      BABYLON.registerWindowRenderingTemplate("BABYLON.Button", "Default", function () {
        return new DefaultButtonRenderingTemplate();
      })
